        ...
        <div className="bg-white dark:bg-slate-700 rounded-2xl shadow-lg p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              By accessing and using the Offline OCR service, you accept and agree to be bound by
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              By submitting images to Offline OCR, you grant Offline OCR a non-exclusive,
              royalty-free, perpetual license to use, copy, modify, and distribute such images for
              the purpose of providing and improving the Service. You represent and warrant that
              you own or have the necessary rights to the images you submit.
            </p>
          </section>
