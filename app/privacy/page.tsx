        ...
        <div className="bg-white dark:bg-slate-700 rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <li>
                <strong>Web Payment Processing (Authorized Reseller):</strong> For users who purchase subscriptions or credits through our website, payment processing is handled securely by our authorized online reseller and Merchant of Record. The reseller collects billing details (such as email, billing address, and payment card information) necessary to process the transaction and comply with global tax regulations. We do not store or have access to your full credit card numbers; we only receive anonymous transaction statuses and purchase tokens linked to your account ID to provision your Plus or Pro features. You can view the reseller&apos;s privacy practices on their official website.
              </li>
              <li>
