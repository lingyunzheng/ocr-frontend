      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-slate-700 rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              Our web order process is conducted by our online reseller, <strong><a href="https://creem.io" target="_blank" rel="noopener noreferrer" className="text-purple-600 dark:text-purple-400 hover:underline">Creem</a></strong>. <strong>Creem is the Merchant of Record</strong> for all our web orders.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Creem provides customer service inquiries and handles returns. If you have any billing or transaction-related concerns for web orders, please contact Creem directly via their support portals.
            </p>
          </section>
